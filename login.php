    ...
    <div class="container col-11 col-md-9" id="form-container">
        <div class="row align-items-center gx-5">
            <div class="col-md-6 order-md-2">
                ...
                <form action="./function-login-diluar-admin/login.php" method="post" id="register-form">
                    ...
                    <div class="g-recaptcha" data-sitekey="6LdblzApAAAAAIHOFAwtuiX0r6latCfXhvTnjXBI"></div>
