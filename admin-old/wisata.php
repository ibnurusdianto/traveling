                            ...
                            <div x-show="open" x-transition x-transition.duration.300 class="panel border-0 p-0 rounded-lg my-8 w-full max-w-lg">
                                ...
                                <div class="p-5">
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        <label for="nama_tempat" class="col-form-label" style="margin-left: 10px">Nama Tempat</label>
                                            <input type="text" name="nama_tempat" placeholder="Nama Tempat" class="form-input" required />
                                        </div>
                                        <label for="kategori" style="margin-left: 10px">Kategori</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="image" class="col-form-label" style="margin-left: 10px">Image</label>
                                            <input type="file" name="image" class="form-input" required></input>
                                        </div>

                                        <div class="mb-3">
                                            <label for="htm" class="col-form-label" style="margin-left: 10px">HTM</label>
                                            <input type="number" name="htm" placeholder="HTM" class="form-input" required />
                                        </div>

                                        <div class="mb-3">
                                            <label for="deskripsi" class="col-form-label" style="margin-left: 10px">Deskripsi</label>
                                        ...
                                        <div class="flex justify-end items-center mt-8 gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="add" @click="showAlert()" style="margin-left: 10px">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
