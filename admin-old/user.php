                ...
                <div x-data="modal" class="mb-5">
                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] hidden" :class="open && '!block'">
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-show="open" x-transition x-transition.duration.300 class="panel border-0 p-0 rounded-lg my-8 w-full max-w-lg">
                                ...
                                <div class="p-5">
                                    <form method="post">
                                        ...
                                        <input type="text" placeholder="Username" name="user" class="form-input" required /> <br><br>
                                        <label for="password" style="margin-left: 10px">Password</label>
                                        <input type="text" placeholder="Password" name="password" class="form-input" required /> <br><br>
                                        ...
                                        <div class="flex justify-end items-center mt-8 gap-2">
                                            <button type="button" class="btn btn-outline-danger" @click="toggle" style="margin-left: 10px">Discard</button>
                                            <button type="submit" class="btn btn-primary" onclick="showAlert()" name="add" style="margin-left: 10px">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <table id="tableAll" class="table-striped table-hover table-bordered table-compact">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <!-- modal edit -->
                                        <div x-show="open === <?= $aksi; ?>" x-cloak class="fixed inset-0 z-[999]" style="background-color: rgba(0, 0, 0, 0.6);">
                                            <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                                                <div x-show="open" x-transition x-transition.duration.300 class="panel border-0 p-0 rounded-lg my-8 w-full max-w-lg">
                                                    <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                                                    ...
                                                    <div class="p-5">
                                                        <form method="post">
                                                            <label for="username" style="margin-left: 10px">Nama User</label>
                                                            <input type="text" name="user" class="form-input" value="<?= $user; ?>" required /> <br><br>
                                                            <label for="password" style="margin-left: 10px">Password</label>
                                                            <input type="text" name="password" class="form-input" value="<?= $password; ?>" required /> <br><br>
                                                            <label for="role" style="margin-left: 10px">Role</label>
                                                            <select class="form-select mb-3" name="role">
                                                                <option selected>Pilih Role</option>
                                                                <option value="admin">Admin</option>
                                                            ...
                                                            <div class=" flex justify-end items-center mt-8 gap-2">
                                                                <button type="button" class="btn btn-outline-danger" @click="toggle" style="margin-left: 10px">Discard</button>
                                                                <button type="submit" class="btn btn-primary" onclick="showAlert()" name="update" style="margin-left: 10px">Submit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
