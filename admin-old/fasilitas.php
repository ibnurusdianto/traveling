                        ...
                        <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                            <div x-show="open" x-transition x-transition.duration.300 class="panel border-0 p-0 rounded-lg my-8 w-full max-w-lg">
                                ...
                                <div class="p-5">
                                    <form method="post">
                                        <div class="mb-3">
                                            <label for="nama_fasilitas" class="col-form-label" style="margin-left: 10px">Nama Fasilitas</label>
                                            <input type="text" name="nama_fasilitas" placeholder="Nama Fasilitas" class="form-input" required />
                                        </div>
                                        <label for="wisata" style="margin-left: 10px">Wisata</label>
                                        ...
                                        <div x-show="open === <?= $aksi; ?>" x-cloak class="fixed inset-0 z-[999]" style="background-color: rgba(0, 0, 0, 0.6);">
                                            <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                                                <div x-show="open" x-transition x-transition.duration.300 class="panel border-0 p-0 rounded-lg my-8 w-full max-w-lg">
                                                    ...
                                                    <div class="p-5">
                                                        <form method="post">
                                                            <label for="nama_fasilitas" style="margin-left: 10px">Edit Fasilitas</label>
                                                            <input type="text" name="nama_fasilitas" class="form-input" value="<?= $nama_fasilitas; ?>" required /><br><br>
                                                            <label for="Wisata" style="margin-left: 10px">Wisata</label>
                                                            <select class="form-select mb-3" name="wisata">
                                                                <option selected>Pilih Wisata</option>
                                                                <?php
