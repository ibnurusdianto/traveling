    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="card">
                                ...
                                <div class="modal-body">
                                    <form method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select mb-3" name="wisata" aria-label="Default select example">
                ...
                <div class="card-body">
                    <h5 class="mb-3">Data Fasilitas</h5>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post">
                                                        <div class="mb-3">
                                                            <label for="nama_fasilitas" class="col-form-label">Nama Fasilitas</label>
                                                            <input type="text" name="nama_fasilitas" class="form-control" value="<?= $nama_fasilitas; ?>" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="wisata">Wisata</label>
                                                            <select class="form-select mb-3" name="wisata" aria-label="Default select example">
                                                                ...
                                                                while ($fetcharray = mysqli_fetch_array($ambildata)) {
                                                                    ...
                                                                    $nama_tempat = $fetcharray['nama_tempat'];
                                                                ?>
                                                                    <option value="<?= $tempatid; ?>" <?php if ($tempatid == $tempat_wisata_id) echo "selected"; ?>><?= $nama_tempat; ?></option>
                                                                <?php
                                                                }
                                                                ?>
                                                            </select>
