                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <span class="text-dark small pt-1 fw-bold">Terdapat sejumlah <?php echo $jumlahwisata; ?> Wisata yang tesedia saat ini</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <span class="text-dark small pt-1 fw-bold">Terdapat sejumlah <?php echo $jumlahkategori; ?> Kategori yang tesedia saat ini</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <span class="text-dark small pt-1 fw-bold">Terdapat sejumlah <?php echo $jumlahfasilitas; ?> Fasilitas yang tesedia saat ini</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <span class="text-dark small pt-1 fw-bold">Terdapat sejumlah <?php echo $jumlahreview; ?> Review yang tesedia saat ini</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <span class="text-dark small pt-1 fw-bold">Terdapat sejumlah <?php echo $jumlahuser; ?> User yang tesedia saat ini</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
