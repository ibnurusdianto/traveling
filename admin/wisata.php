                ...
                <div class="card-header">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Wisata</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_tempat" placeholder="Nama Tempat" class="form-control" required />
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="htm" placeholder="HTM" class="form-control" required />
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="mb-3">
                                                            <label for="nama_tempat" class="col-form-label">Nama Tempat</label>
                                                            <input type="text" name="nama_tempat" placeholder="Nama Tempat" class="form-control" value="<?= $nama_tempat; ?>" required />
                                                        </div>
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select mb-3" name="kategori">
                                                                ...
                                                                while ($fetcharray = mysqli_fetch_array($ambildata)) {
                                                                    ...
                                                                    $idkategori = $fetcharray['id'];
                                                                ?>
                                                                    <option value="<?= $idkategori; ?>" <?php if ($idkategori == $kategori) echo "selected"; ?>><?= $nama_kategori; ?></option>
                                                                <?php
                                                                }
                                                                ?>
                                                            </select>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="htm" class="col-form-label">HTM</label>
                                                            <input type="number" placeholder="Htm" name="htm" class="form-control" value="<?= $harga; ?>" required />
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="deskripsi" class="col-form-label">Deskripsi</label>
                                                            <textarea name="deskripsi" placeholder="Deskripsi" class="form-control" required><?= $deskripsi; ?></textarea>
                                                        </div>
